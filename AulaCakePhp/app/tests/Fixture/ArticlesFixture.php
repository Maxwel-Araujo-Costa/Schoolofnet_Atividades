...
class ArticlesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'url' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'created' => '2020-02-06 18:40:58',
                'modified' => '2020-02-06 18:40:58',
            ],
        ];
        parent::init();
    }
