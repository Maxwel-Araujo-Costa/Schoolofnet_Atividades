...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'locale' => ['type' => 'string', 'length' => 5, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'locale' => 'Lor',
                'created' => '2020-03-02 18:35:22',
                'modified' => '2020-03-02 18:35:22',
            ],
        ];
        parent::init();
    }
